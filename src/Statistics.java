...
public class Statistics extends Application {
	...
	public static void generalResults() throws Exception {
		...
		JOptionPane.showMessageDialog(frame2,
				"Total number of services is: " + k + "\r\n Total number of clients is: " + num
						+ "\r\n The service with the greatest demand collected maximum number of visitors: " + max
						+ "\r\n The service with the least demand collected minimum number of visitors: " + min
						+ "\r\n The average number of visitors from all services is: "
						+ Client.numOfClients / (double) Services.eidikotites.size());
	...
	public static void evaluationResults() throws Exception {
		...
		text.append("\r\n\r\nThe average evaluation for each question is: " + "\r\n");
		...
		JOptionPane.showMessageDialog(frame2,
				"The question that collected on average the lowest rating is: \r\n" + (answer2 + 1) + " \""
						...
						+ " \"" + Evaluation.questions.get(answer) + "\"   " + "   with an average of response: "
						+ max2);
	...
	private static void servicesResults() {
		...
		StringBuilder text = new StringBuilder();
		text.append("Statistic results for Services:" + "\r\n\r\n");
